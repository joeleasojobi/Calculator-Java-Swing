...
public class calculator implements ActionListener {
    ...
    public calculator() {
        ...
        JLabel brandlabel = new JLabel("Joel");
        brandlabel.setBounds(30, 100, 100, 20);
        jf.add(brandlabel);
        ...
        divbtn = new JButton("/");
        divbtn.setBounds(270, 130, 50, 50);
        ...
        mulbtn = new JButton("*");
        mulbtn.setBounds(270, 190, 50, 50);
        ...
        subbtn = new JButton("-");
        subbtn.setBounds(270, 250, 50, 50);
        ...
        addbtn = new JButton("+");
        addbtn.setBounds(270, 310, 50, 50);
